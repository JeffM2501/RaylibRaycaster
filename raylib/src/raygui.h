...
Rectangle GuiScrollPanel(Rectangle bounds, Rectangle content, Vector2 *scroll)
{
    ...
    if (scrollPos.x > -horizontalMin) scrollPos.x = horizontalMin * -1.0f;
    if (scrollPos.x < -horizontalMax) scrollPos.x = horizontalMax * -1.0f;
    if (scrollPos.y > -verticalMin) scrollPos.y = verticalMin * -1.0f;
    if (scrollPos.y < -verticalMax) scrollPos.y = verticalMax * -1.0f;
    //--------------------------------------------------------------------
